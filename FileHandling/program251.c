//Accept 2 files from user and copy the data of first file in second file -Append
/*
Enter file name which contains the data
LB20.txt
...
void AppenData(char Source[], char Destination[])
{
